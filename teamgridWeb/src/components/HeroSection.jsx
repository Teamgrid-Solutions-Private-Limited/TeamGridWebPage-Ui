...
const orbitPlanetsData = [
  [
    ...
    },
    {
      img: P11,
      name: "Next.js",
      description: "React framework for production-grade server-rendered applications.",
    },
    { img: P111, name: "Gatsby", description: "React-based static site generator for fast websites." },
  ],
  [
    {
      img: P2,
    ...
    { img: P22, name: "Express", description: "Fast, unopinionated web framework for Node.js applications." },
  ],
  [
    { img: P3, name: "MongoDB", description: "Document-based NoSQL database for modern applications." },
    { img: P33, name: "PostgreSQL", description: "Advanced open-source relational database system." },
  ],
  [
    { img: P4, name: "WordPress", description: "Popular open-source content management system." },
    {
      img: P44,
      name: "WooCommerce",
...
const CenterPiece = ({ setSelectedPlanet, selectedPlanet, setLogoZoomed }) => {
  ...
  const logoSize = window.innerWidth < 600 ? { width: "200px", height: "200px" } : 
                   window.innerWidth < 900 ? { width: "250px", height: "250px" } : 
          ...
          {isZoomed && selectedPlanet && (
            <motion.div
              ...
              style={{
                ...
                color: "#fff",
                padding: window.innerWidth < 900 ? "60px 28px 32px" : "28px 28px 32px",
        ...
        <Box sx={{ 
          ...
          <Button
            ...
            sx={{
              ...
              backgroundColor: "#1A73E8",
              borderRadius: "40px",
              width: { xs: "100%", sm: "160px", md: "204px" },
          ...
          <Button
            ...
            sx={{
              ...
              color: "#fff",
              height: { xs: "48px", md: "50px" },
              width: { xs: "100%", sm: "180px", md: "230px" },
              fontSize: { xs: "14px", md: "18px" },
              borderRadius: "40px",
              fontWeight: 400,
              textTransform: "none",
